...
// Check if a character is romanced based on quest facts
public func IsCharacterRomanced(character: CharacterSetting) -> Bool {
    let player = GetPlayer(GetGameInstance());
    let questSystem = GameInstance.GetQuestsSystem(player.GetGame());
...
public func GetCharacterRelationship(character: CharacterSetting) -> String {
    let isRomanced = IsCharacterRomanced(character);
